      ...
      <DashboardLayout variant="operator" requiredRole="operator">
        <div className="py-10 px-10 min-h-screen bg-[#F3F3EE] font-myriad">
          <div className="max-w-4xl space-y-10">
            ...
            {/* Рабочий график */}
            <section>
              <h2 className="text-lg text-gray-900 mb-4 pb-2 border-b border-gray-200">Рабочий график</h2>
            ...
            <section>
              <h2 className="text-lg text-gray-900 mb-4 pb-2 border-b border-gray-200">Общение с руководством</h2>
              <ul className="space-y-2 text-gray-700">
            ...
            <section>
              <h2 className="text-lg text-gray-900 mb-4 pb-2 border-b border-gray-200">Основные обязанности</h2>
              <ul className="space-y-2 text-gray-700">
            ...
            {/* Контроль качества */}
            <section>
              <h2 className="text-lg text-gray-900 mb-4 pb-2 border-b border-gray-200">Контроль качества</h2>
              <div className="text-gray-700 space-y-2">
                ...
                <ul className="space-y-1 ml-4">
                  ...
                  <li className="text-red-600">Если клиент не доволен или цена отличается от заявленной в CRM — срочно оповестить директора</li>
                </ul>
              </div>
            </section>
            ...
            {/* Примеры общения */}
            <section>
              <h2 className="text-lg text-gray-900 mb-4 pb-2 border-b border-gray-200">Примеры сообщений по заказам</h2>
              <ul className="space-y-2 text-gray-700">
            ...
            {/* Сокращения */}
            <section>
              <h2 className="text-lg text-gray-900 mb-4 pb-2 border-b border-gray-200">Сокращения</h2>
              ...
              <div className="mt-4 pt-4 border-t border-gray-200 space-y-1 text-gray-700">
                <div><span className="text-red-600">Незаказ</span> — Техника, которую не ремонтируем</div>
                <div><span className="text-gray-500">Модерн</span> — Мастер забрал технику на ремонт</div>
              </div>
            </section>

            {/* Важно */}
            <section className="bg-red-50 p-6 rounded-lg border border-red-200">
              <h2 className="text-lg text-red-700 mb-2">Важно</h2>
